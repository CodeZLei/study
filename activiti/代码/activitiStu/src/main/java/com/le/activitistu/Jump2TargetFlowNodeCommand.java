...
public class Jump2TargetFlowNodeCommand implements Command<Void> {
	...
	private String remoreReason;

	public Jump2TargetFlowNodeCommand(String curTaskId, String targetFlowNodeId, String remoreReason) {
		super();
		this.curTaskId = curTaskId;
		this.targetFlowNodeId = targetFlowNodeId;
		this.remoreReason = remoreReason;
	}
	...
	public Void execute(CommandContext commandContext) {
		...
		// 删除当前节点
		taskEntityManager.deleteTask(taskEntity, remoreReason, false, false);
		// 获取要跳转的目标节点
